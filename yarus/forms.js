/* ============================================================
   Формы «Яруса»: заявка на торт и запись на дегустацию.
...
(function () {
  ...
  var FILLINGS = [
    ...
    'Три шоколада',
    'Пока не выбрали — хотим попробовать на дегустации'
  ];

  var SIZES = [
    { value: '3—5 кг', hint: '25—35 гостей' },
    { value: '5—8 кг', hint: '35—55 гостей' },
    { value: '8—12 кг', hint: '55—80 гостей' },
    { value: 'Больше 12 кг', hint: 'от 80 гостей' }
  ];
  ...
  var FORMS = {
    order: {
      lead: 'Опишите свадьбу один раз — и мы сможем назвать цену без долгой переписки.',
      submit: 'Отправить заявку',
      header: '💍 Заявка на свадебный торт',
      steps: [
        { name: 'kind', legend: 'Тип торта', required: true, err: 'Выберите тип торта.',
          type: 'options', cols: 2, options: ['Из каталога', 'По эскизу'], label: 'Тип' },
        { name: 'filling', legend: 'Начинка', type: 'select', options: FILLINGS, label: 'Начинка',
          placeholder: 'Выберите начинку' },
        { name: 'size', legend: 'Вес и гости', note: 'ярусы подберём под число гостей',
          type: 'options', cols: 2, options: SIZES, custom: 'Свой вариант',
          customPlaceholder: 'Например: 6,5 кг или 48 гостей', label: 'Вес' },
        { name: 'date', legend: 'Дата свадьбы', required: true, err: 'Укажите дату свадьбы.',
          type: 'date', label: 'Дата' },
        { name: 'design', legend: 'Пожелания по дизайну', type: 'textarea', label: 'Дизайн',
          placeholder: 'Палитра, стиль, цветы, надпись, что точно не нравится' },
        { name: 'refs', legend: 'Референс-фото', type: 'files', label: 'Референсы' },
        { name: 'contact', legend: 'Контакт для связи', required: true, type: 'contact' }
      ]
    },

    tasting: {
      lead: 'Запишитесь — подтвердим время и пришлём адрес шоурума.',
      submit: 'Записаться на дегустацию',
      header: '🍰 Запись на дегустацию',
      compact: true,
      steps: [
        { name: 'date', legend: 'Удобная дата', required: true, err: 'Выберите удобную дату.',
          type: 'date', label: 'Дата' },
        { name: 'guests', legend: 'Сколько человек придёт', type: 'number', min: 1, max: 4,
          placeholder: 'например, 2', note: 'в комнате помещаются четверо', label: 'Гостей' },
        { name: 'wedding', legend: 'Дата свадьбы', type: 'date', note: 'если уже известна', label: 'Свадьба' },
        { name: 'contact', legend: 'Контакт для связи', required: true, type: 'contact' }
      ]
    }
  };
